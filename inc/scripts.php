...
function sme_styles() {
    ...
    wp_register_style('normalize',  get_template_directory_uri() . '/css/a-normalize.css', false, '2.0');
    wp_register_style('main',       get_template_directory_uri() . '/css/main.css', false, '2.0' );
    wp_register_style('sme_fonts',  get_template_directory_uri() . '/css/fonts.css', false, '2.0');
