...
function sme_styles() {
    ...
    wp_register_style('normalize',  get_template_directory_uri() . '/css/a-normalize.css', false, '1.0.7');
    wp_register_style('main',       get_template_directory_uri() . '/css/main.css', false, '1.0.7' );
    wp_register_style('sme_fonts',  get_template_directory_uri() . '/css/fonts.css', false, '1.0.7');
